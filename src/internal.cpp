...
{   
    ...
    LOG_TO_FILE("/home/wgf/chenli/SAT/logging-kalman/log", "conflicts : %lld" " 先验估计值 %f", stats.conflicts, stats.kalman.fG_c);
    stats.kalman.P_a = stats.kalman.P_b + stats.kalman.Q;
    LOG_TO_FILE("/home/wgf/chenli/SAT/logging-kalman/log", "conflicts : %lld" " 先验估计协方差 %f", stats.conflicts, stats.kalman.P_a);
    /* 修正 */
    //获取观测值
    stats.kalman.fG_b = fastGlue;
    LOG_TO_FILE("/home/wgf/chenli/SAT/logging-kalman/log", "conflicts : %lld" " 观测值 %f", stats.conflicts, stats.kalman.fG_b);
    //计算卡尔曼增益
    stats.kalman.K = stats.kalman.P_a / (stats.kalman.P_a + stats.kalman.R);   
    LOG_TO_FILE("/home/wgf/chenli/SAT/logging-kalman/log", "conflicts : %lld" " 卡尔曼增益 %f", stats.conflicts, stats.kalman.K);
    LOG_TO_FILE("/home/wgf/chenli/SAT/logging-kalman/log", "conflicts : %lld" " 测量噪声 %f", stats.conflicts, stats.kalman.R);
    //最佳估计值           
    ...
    LOG_TO_FILE("/home/wgf/chenli/SAT/logging-kalman/log", "conflicts : %lld" " 后验估计协方差 %f", stats.conflicts, stats.kalman.P_b);
    LOG_TO_FILE("/home/wgf/chenli/SAT/logging-kalman/log", "conflicts : %lld" " 最佳估计值 %f", stats.conflicts, stats.kalman.fG_c);
    //返回修正估计值
